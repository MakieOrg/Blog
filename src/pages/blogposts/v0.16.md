...
That turned `Scene` into a more canvas like type acting in the background, but it still contained all the high-level constructs to control limits, axis etc.
...
GLMakie is now back to have high quality text rendering :)
