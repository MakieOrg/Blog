...
scatter!(x, y, color = z, strokewidth = 1, strokecolor = :black)
path = Blog.site_path("images", "tricontourf.png")
Makie.save(path, f; px_per_unit=2.0)
DOM.img(src="/images/tricontourf.png")
```
...
path = Blog.site_path("images", "hexbin.svg")
Makie.save(path, f)
DOM.img(src="/images/hexbin.svg")
```
