...
var hljs = function() {
    ...
    var _ = Object.freeze({
        ...
        SHEBANG: (e = {})=>{
            const t = /^#![ ]*\//;
            return e.binary && (e.begin = ((...e)=>e.map((e)=>g(e)).join(""))(t, /.*\b/, e.binary, /\b.*/)), a({
                className: "meta",
                begin: t,
                end: /$/,
                relevance: 0,
    ...
    function T(e, { plugins: t  }) {
                ...
                this.matcherRe = n(((e, t = "|")=>{
                    ...
                    return e.map((e)=>{
                        ...
                        for(; i.length > 0;){
                            ...
                            s += i.substring(0, e1.index), i = i.substring(e1.index + e1[0].length), "\\" === e1[0][0] && e1[1] ? s += "\\" + (Number(e1[1]) + t) : (s += e1[0], "(" === e1[0] && n++);
                        }
                        return s;
                    }).map((e)=>`(${e})`).join(t);
        ...
        class s {
            ...
            exec(e) {
                ...
                let n = t.exec(e);
                if (this.resumingScanAtSamePosition()) if (n && n.index === this.lastIndex) ;
                else {
        ...
        return e.classNameAliases = a(e.classNameAliases || {}), function t(i, r) {
            ...
            [
                A
            ].forEach((e)=>e(i, r)), e.compilerExtensions.forEach((e)=>e(i, r)), i.__beforeBegin = null, [
                M,
                O,
                L
            ].forEach((e)=>e(i, r)), i.isCompiled = !0;
            let o = null;
        ...
        "after:highlightElement": ({ el: e , result: t , text: n  })=>{
            ...
            a.innerHTML = t.value, t.value = ((e, t, n)=>{
                ...
                for(; e.length || t.length;){
                    let t1 = l();
                    if (a += s(n.substring(i, t1[0].offset)), i = t1[0].offset, t1 === e) {
                        r.reverse().forEach(c);
                        do {
                            g(t1.splice(0, 1)[0]), t1 = l();
                        }while (t1 === e && t1.length && t1[0].offset === i)
                        r.reverse().forEach(o);
                    } else "start" === t1[0].event ? r.push(t1[0].node) : r.pop(), g(t1.splice(0, 1)[0]);
                }
    ...
    return ((e)=>{
        ...
        function d(e, t, n, i) {
            let s = "", a = "";
            "object" == typeof t ? (s = e, n = t.ignoreIllegals, a = t.language, i = void 0) : (z("10.7.0", "highlight(lang, code, ...args) has been deprecated."), z("10.7.0", "Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"), a = e, s = t);
            const r = {
                code: s,
                language: a
            };
        ...
        function f(e, t, s, l) {
            ...
            function g() {
                null != R.subLanguage ? (()=>{
                    ...
                    for(; t;){
                        ...
                        if (i) {
                            const [e1, s] = i;
                            if (k.addText(n), n = "", O += s, e1.startsWith("_")) n += t[0];
                            else {
                                const n1 = v.classNameAliases[e1] || e1;
                                k.addKeyword(t[0], n1);
                            }
                        } else n += t[0];
            ...
            function d(e, t, n) {
                ...
                if (s) {
                    if (e["on:end"]) {
                        const n1 = new i(e);
                        e["on:end"](t, n1), n1.isMatchIgnored && (s = !1);
                    }
                    if (s) {
            ...
            function x(n, a) {
                ...
                if ("begin" === E.type && "end" === a.type && E.index === a.index && "" === l) {
                    if (M += t.slice(a.index, a.index + 1), !r) {
                        const t1 = Error("0 width match regex");
                        throw t1.languageName = e, t1.badRule = E.rule, t1;
                    }
                    return 1;
                }
                if (E = a, "begin" === a.type) return function(e) {
                    const t = e[0], n = e.rule, s = new i(n), a = [
                        n.__beforeBegin,
                        n["on:begin"]
                    ];
                    for (const n1 of a)if (n1 && (n1(e, s), s.isMatchIgnored)) return m(t);
                ...
                if ("illegal" === a.type && !s) {
                    const e1 = Error('Illegal lexeme "' + l + '" for mode "' + (R.className || "<unnamed>") + '"');
                    throw e1.mode = R, e1;
                }
                if ("end" === a.type) {
                    const e2 = b(a);
            ...
            try {
                for(R.matcher.considerAll();;){
                    ...
                    const e1 = R.matcher.exec(t);
                    if (!e1) break;
                    const n1 = x(t.substring(A, e1.index), e1);
                    A = e1.index + n1;
                }
        ...
        function x(e) {
            ...
            const n = ((e)=>{
                ...
                if (n) {
                    const t1 = N(n[1]);
                    return t1 || (U(o.replace("{}", n[1])), U("Falling back to no-highlight mode for this block.", e)), t1 ? n[1] : "no-highlight";
                }
        ...
        "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", ()=>{
            ...
            highlightAll: y,
            fixMarkup: (e)=>{
                return z("10.2.0", "fixMarkup will be removed entirely in v11.0"), z("10.2.0", "Please see https://github.com/highlightjs/highlight.js/issues/2534"), t = e, u.tabReplace || u.useBR ? t.replace(l, (e)=>"\n" === e ? u.useBR ? "<br>" : e : u.tabReplace ? e.replace(/\t/g, u.tabReplace) : e) : t;
                var t;
            },
            highlightElement: x,
            highlightBlock: (e)=>(z("10.7.0", "highlightBlock will be removed entirely in v12.0"), z("10.7.0", "Please use highlightElement now."), x(e)),
            configure: (e)=>{
            ...
            registerLanguage: (t, i)=>{
                ...
                try {
                    ...
                    if ($("Language definition for '{}' could not be registered.".replace("{}", t)), !r) throw e1;
                    $(e1), s = g;
                }
        ...
        for(const e1 in _)"object" == typeof _[e1] && t(_[e1]);
